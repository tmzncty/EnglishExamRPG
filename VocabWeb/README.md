...
**📚 学习规则优化**
- ✅ **新词/复习分离**：每日新词目标（默认为 40 个）不再包含复习词。现在你每天会实打实地学习到指定数量的新单词。
- ✅ **无限学习模式**：刷新页面会自动补充新词，不再受限于“今日已学数量”，想学多少就学多少（可超额完成）。
- ✅ **精准统计**：引入 `first_learned_at` 字段，精准区分“今日新学”和“今日复习”的数据，修复了统计混乱的问题。

**📱 界面与体验升级**
- ✅ **手机端 UI 适配**：优化了顶部导航栏和统计面板在移动端的布局，操作更顺手，视觉更清爽。
- ✅ **进度可视化**：新增“预计完成天数”显示，根据当前剩余生词量和每日目标，自动计算还要多少天学完。
- ✅ **字体优化**：调整了部分区域的字体大小，提升阅读体验。
