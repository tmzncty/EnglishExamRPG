...
> 其实我本来想打galgame的标签的，但是有点蹭热度，所以我就自己玩吧，发现了就发现了。
...
### v3.2.2 (2026-01-26) - Multi-Year Question Selector Fix 🔧

**修复内容**:
*   🐛 **题目选择器多年份分组修复**:
    - 修复选择多个年份时，相同section名称的题目被合并显示的问题
    - 多年份模式下，section标题现在显示年份前缀（例如："2010 - Section II Part A Text 3"）
    - 每个年份的题目现在独立分组显示，不再出现重复题号
    - 单年份模式保持原有行为，确保向后兼容
